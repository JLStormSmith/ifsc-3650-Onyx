...
function clearform() {
    ...
    document.getElementById("CenOperator").checked = false;
    document.getElementById("MetOperator").checked = false;
    document.getElementById("KiloOperator").checked = false;
    document.getElementById("IncOperator").checked = false;
